...
public class Column_socket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_column_socket);
        ...
        subbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (plainEdit.getText().toString().equals("")) {
                    Toast.makeText(Column_socket.this, "请输入明文！", Toast.LENGTH_SHORT).show();
                } else if (keyEdit.getText().toString().equals("")) {
                    Toast.makeText(Column_socket.this, "请输入秘钥", Toast.LENGTH_SHORT).show();
                } else {
                    if (bindIntent == null) {
                        //如果还没有绑定，则：
                        /*********   绑定socket服务   ***********/
                        bindIntent = new Intent(Column_socket.this, MySocketService.class);
        ...
        decipherbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (n == i) {
                    Toast.makeText(Column_socket.this, "无消息，请等待...", Toast.LENGTH_SHORT).show();
                } else {
                    plaintext = decrypt.ColumnPermutationcipher(ciphertext[n], keyEdit.getText().toString());
                    n++;
    ...
    private void sendMessage() throws RemoteException {
        ...
        msg.obj = encrypt.ColumnPermutationcipher(plainEdit.getText().toString(), keyEdit.getText().toString());
        rMessenger.send(msg);
    }
}
